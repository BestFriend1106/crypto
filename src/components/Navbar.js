        ...
        <nav className="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
            <div className="container" id='_nav_container'>            
                <a className="navbar-brand logo text-uppercase" href="/home-one" id='_nav_logo'>
                    <img src="images/cryptofox/FOX.png" className="logo logo_white" />
                     CRYPTOFOX
                </a>
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    <ul className="navbar-nav navbar-center" id="mySidenav">
                        ...
                        <li className="nav-item">
                            <a href="#services" className="nav-link">About Event</a>
                        </li>
                        <li className="nav-item">
                            <a href="#features" className="nav-link">Discussion Topics</a>
                        </li>
                        <li className="nav-item">
                            <a href="#team" className="nav-link">Speakers</a>
                        </li>
                        <li className="nav-item">
                            <a href="#testi" className="nav-link">Sponsers</a>
                        </li>
                    </ul>
                </div>
